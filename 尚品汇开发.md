...
**totalPages ： total/pageSize    总页数**

**currentPage：当前页码**

**pagerCount：显示按钮的数量**

**count：pagerCount-2  ，显示按钮数量-2**
...
import loading from "../assets/imags/loading.gif"   //引入图片，直接使用解析不了 
