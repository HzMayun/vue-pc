          ...
          <div class="order-content">
            ...
            <div class="orders">
              ...
              >
                ...
                <tbody>
                  <tr v-for="detail in record.orderDetailList" :key="detail.id">
                    <td width="60%">
...
<script>
import { reqPayment, reqMyOrder } from "@api/pay";
export default {
  name: "",
  data() {
    return {
  ...
  async mounted() {
    const page = 1;
    const limit = 10;
    this.order = await reqMyOrder({ page, limit });
